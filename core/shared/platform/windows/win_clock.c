...
static int
calculate_monotonic_clock_frequency(uint64 *outfrequency)
{
    ...
    if (!QueryPerformanceFrequency(&frequency)) {
        ...
        *outfrequency = (uint64)frequency.QuadPart;
        return BHT_OK;
    }
}
...
uint64
get_performance_counter_value(uint64 *outcounter)
{
